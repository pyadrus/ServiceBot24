greeting_post = ("<b>👋 @PyAdminRUS приветствую вас в моем 🤖 Telegram-боте!</b>\n\n"
                 ...
                 "мне</code> @rusdnpy <code>для анализа.</code>\n\n"
                 ...
                 "всегда готов помочь вам @rusdnpy.</i>")
...
message_text_faq = ("📢 Вы можете связаться со мной в следующих социальных сетях:\n\n"
                    ...
                    "<a href='https://t.me/bot_telegram_SMM_help'>@bot_telegram_SMM_help</a>\n"
